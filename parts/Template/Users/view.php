<div class="container">
	<div class="row">
		<h1 class="center-align">Votre profil</h1>
		<div class="col s12">
			<?php if (isset($error)): ?>
				<?php echo $error; ?>
			<?php endif ?>
			...
			<div class="col s12">
				<div class="row">
					<div class="input-field col s8 offset-s2">
						<input value="<?php echo $username ?>" type="text" name="username" id="username" disabled>
						<label for="username" data-error="trop court" >Nom d'utilisateur</label>
					</div>
				</div>
				<div class="row">
					<div class="input-field col s8 offset-s2">
						<input type="password" id="password" name="password" class="validate" pattern="[a-zA-Z0-9]{4,}">
						<label for="password" data-error="trop court" >Nouveau mot de passe</label>
					</div>
				</div>
				<div class="row">
					<div class="input-field center-align">
						<button class="btn waves-effect waves-light" type="submit" name="maj_pwd">
							Mettre à jour
